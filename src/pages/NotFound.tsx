    ...
    render() {
        return (
            <div style={{position: 'relative'}}>
                <img src={back} style={{position: 'absolute', zIndex: -1, width: '100%', height: '100%', top: 0, left: 0}}
                     alt={''}/>
                <Stack justifyContent='center' alignItems='center' style={{minHeight: '100vh', zIndex: 2, backgroundColor: 'rgba(0,0,0,0.55)', color: 'white'}}>
